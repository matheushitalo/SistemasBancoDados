...
SELECT venda_id, SUM(quantidade * valor_unitario) AS total_vendas, data_venda
FROM vendas_itens2
GROUP BY venda_id, data_venda
ORDER BY data_venda ASC;


SELECT produto_id, MIN(valor_unitario) AS min_preco, MAX(valor_unitario) AS max_preco, 
